...
public class Graph extends JPanel{
	...
	public void chooseGraph(int x,int y,Graphics g){
		...
		if(mapToPrint.getMatrix()[x+1][y].retCoord().retZ() > mapToPrint.getMatrix()[x][y].retCoord().retZ()){
			file = new File("C:\\Users\\Crejzer\\workspace\\MassiveMultiplaerOnline\\grafiki\\102.png");
			try {
				BufferedImage image =ImageIO.read(file);
				image.createGraphics();
				g2d.drawImage(image,x*50,y*50,null);
		...
		if(mapToPrint.getMatrix()[x][y+1].retCoord().retZ() > mapToPrint.getMatrix()[x][y].retCoord().retZ()){
			file = new File("C:\\Users\\Crejzer\\workspace\\MassiveMultiplaerOnline\\grafiki\\103.png");
			try {
				BufferedImage image =ImageIO.read(file);
				image.createGraphics();
				g2d.drawImage(image,x*50,y*50,null);
		...
		if(mapToPrint.getMatrix()[x-1][y].retCoord().retZ() > mapToPrint.getMatrix()[x][y].retCoord().retZ()){
			file = new File("C:\\Users\\Crejzer\\workspace\\MassiveMultiplaerOnline\\grafiki\\104.png");
			try {
				BufferedImage image =ImageIO.read(file);
				image.createGraphics();
				g2d.drawImage(image,x*50,y*50,null);
		...
		if(mapToPrint.getMatrix()[x-1][y-1].retCoord().retZ() > mapToPrint.getMatrix()[x][y].retCoord().retZ()){
			file = new File("C:\\Users\\Crejzer\\workspace\\MassiveMultiplaerOnline\\grafiki\\109.png");
			try {
				BufferedImage image =ImageIO.read(file);
				image.createGraphics();
				g2d.drawImage(image,x*50,y*50,null);
		...
		if(mapToPrint.getMatrix()[x+1][y-1].retCoord().retZ() > mapToPrint.getMatrix()[x][y].retCoord().retZ()){
			file = new File("C:\\Users\\Crejzer\\workspace\\MassiveMultiplaerOnline\\grafiki\\110.png");
			try {
				BufferedImage image =ImageIO.read(file);
				image.createGraphics();
				g2d.drawImage(image,x*50,y*50,null);
		...
		if(mapToPrint.getMatrix()[x+1][y+1].retCoord().retZ() > mapToPrint.getMatrix()[x][y].retCoord().retZ()){
			file = new File("C:\\Users\\Crejzer\\workspace\\MassiveMultiplaerOnline\\grafiki\\111.png");
			try {
				BufferedImage image =ImageIO.read(file);
				image.createGraphics();
				g2d.drawImage(image,x*50,y*50,null);
		...
		if(mapToPrint.getMatrix()[x-1][y+1].retCoord().retZ() > mapToPrint.getMatrix()[x][y].retCoord().retZ()){
			file = new File("C:\\Users\\Crejzer\\workspace\\MassiveMultiplaerOnline\\grafiki\\112.png");
			try {
				BufferedImage image =ImageIO.read(file);
				image.createGraphics();
				g2d.drawImage(image,x*50,y*50,null);
	...
	public void paintComponent(Graphics g) {
		...
		int height;
		File file;
		file = new File("C:\\Users\\Crejzer\\workspace\\MassiveMultiplaerOnline\\grafiki\\113.png");
		Graphics2D g2d = (Graphics2D) g;
